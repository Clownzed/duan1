                            ...
                            <div class="card mask-custom">
                                <div class="card-body p-5 text-white">
                                    ...
                                    <div class="my-4">
                                        ...
                                        <form action="index.php?act=add_prd" method="POST" enctype="multipart/form-data">
                                            <!-- 2 column grid layout with text inputs for the first and last names -->
                                            <div class="row">
                                                <div class="col-12 col-md-6 mb-4">
                                                    <div class="form-outline form-white">
                                                        <input type="text" id="form3Example1" class="form-control form-control-lg" name="name_prd" />
                                                        <label class="form-label" for="form3Example1">Tên Loại hàng </label>
                                                    </div>
                                                </div>
                                                <div class="col-12 col-md-6 mb-4">
                                                    <div class="form-outline form-white">
                                                        <input type="text" id="form3Example2" class="form-control form-control-lg" name="price_prd" />
                                            ...
                                            <div class="form-outline form-white mb-4">
                                                ...
                                                <textarea id="form3Example3" cols="10" rows="5" class="form-control form-control-lg" name="desc_prd"></textarea>
                                            ...
                                            <!-- Submit button -->
                                            <button type="submit" class="btn btn-light btn-block mb-4" name="btn_add_prd">Thêm sản phẩm</button>
